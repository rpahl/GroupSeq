...
<table style="border: 0px solid white; border-collapse: collapse; text-align:left">
    <tr>
        <td><a href="https://rpahl.github.io/GroupSeq/articles/1-compute-bounds-H0.html"><img src="figures/task1-menu.png" alt="1- Compute Bounds" style="width:80%"></a></td>
        <td>
            <ul>
...
<table style="border: 0px solid white; border-collapse: collapse; text-align:left">
    <tr>
        <td><a href="https://rpahl.github.io/GroupSeq/articles/2-compute-drift.html"><img src="figures/task2-menu.png" alt="-2- Compute Drift given Power and Bounds" style="width:80%"></a></td>
        <td>
            <ul>
...
at the final analysis, that is, this option may be used in the planning phase
or in practice after data collection when performing the final evaluation. 

<table style="border: 0px solid white; border-collapse: collapse; text-align:left">
    <tr>
        <td><a href="https://rpahl.github.io/GroupSeq/articles/4-compute-CI.html"><img src="figures/task4-menu.png" alt="-4- Compute Confidence Interval" style="width:80%"></a></td>
        <td>
            <ul>
