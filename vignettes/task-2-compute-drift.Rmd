...
```{r, out.width = "35%", echo = FALSE, fig.alt = "task-2-menu"}
...
```{r, out.width = c("55%", "40%"), echo = FALSE, fig.show="hold", fig.alt = "three-stage-OBF-results"}
...
```{r, out.width = "50%", fig.alt = "three-stage-pocock-result"}
...
```{r, out.width = "35%", fig.alt = "task-2-set-power"}
...
```{r, out.width = "50%", fig.alt = "three-stage-pocock-power-result"}
...
```{r, out.width = "35%", echo = FALSE, fig.alt = "task-2-set-manual-bounds"}
...
```{r, out.width = "50%", fig.alt = "three-stage-pocock-manual-bounds-result"}
