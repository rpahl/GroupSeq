...
of the study so that only 0.069% of alpha is spent at stage 1. This means,
that the effect would have to be very large in order to exceed the critical
upper bound of 3.2 having collected 33% of the total sample.
...
<br>
As you see the resulting upper bounds are set constant over all stages at
